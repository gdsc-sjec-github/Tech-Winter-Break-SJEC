...
const CreateModal = () => {
  ...
  return (
    <>
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50" onClick={() => closeModal('create')}>
            <div className="flex flex-col min-w-[500px] p-14 bg-white rounded-3xl opacity-100 z-10" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center mb-8">
                    <button className="inline border border-zinc-900 p-2 rounded-full overflow-hidden" onClick={() => closeModal('create')} ><X /></button>
                    <h2 className="text-center mx-auto font-bold text-lg sm:text-xl">Place your Order</h2>
                </div>
