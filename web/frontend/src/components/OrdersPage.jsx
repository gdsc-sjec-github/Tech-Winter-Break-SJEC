...
const OrdersPage = () => {
   ...
   return (
     <div className={`flex-1 ml-20 pl-4 md:ml-2 md:pl-2 transition-all duration-300 ease-in-out`}>
         <div>
           <h1 className="mt-10 text-xl font-semibold sm:text-3xl sm:font-bold pl-8">Order Log</h1>
           <p className="mt-1 text-gray-500 text-xs sm:text-sm pl-8">Home {'>'} Order Log</p>
         ...
         <div className='mt-8'>
             <h1 className="mt-10 text-xl font-semibold sm:text-3xl sm:font-bold pl-8">Order Lineup</h1>
             <p className="mt-1 text-gray-500 text-xs sm:text-sm pl-8">Home {'>'} Order Lineup</p>
